...
import { SortDirection, Market, Metric } from "@/constants/enum";

const initialQuery: Query = {
  query: {
    filters: [
      {
        metric: Metric.EPS_DILUTED_QTR_GROWTH,
        preset:
    ...
    sort: {
      metric: Metric.ANALYST_TARGET_UPSIDE,
  ...
  metrics: [
    ...
    Metric.PE_LTM_LATEST,
    Metric.EPS_BASIC_GROWTH,
    Metric.TOTAL_REV_QTR_GROWTH,
    Metric.TOTAL_REV_GROWTH,
    Metric.TOTAL_REV_CAGR_5Y,
  ],
